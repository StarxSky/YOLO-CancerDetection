...
#!ls -a
#print('-------------------------------')
#!rm -rf /kaggle/working/YOLO-Cancer-Detection/label_data/CCC_clean.csv
#!cp CCC_clean.csv /kaggle/working/YOLO-Cancer-Detection/label_data/
...
#!ls -a
#print('-------------------------------')
#!ls /kaggle/working/YOLO-Cancer-Detection/label_data/ -a